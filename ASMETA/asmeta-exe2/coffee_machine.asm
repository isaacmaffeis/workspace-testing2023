...
// Una macchinetta automatica dispensa caffe', te' e latte. 
// La macchinetta accetta solo monete da 50 centesimi e da 1 euro.
// Se viene inserita una moneta da 50 centesimi, la macchinetta dispensa latte (se disponibile);
// se viene inserita una moneta da 1 euro,invece, la macchinetta decide 
// in modo casuale di dispensare caffe' o te' (se disponibili).
...
// La macchina all'inizio contiene 10 unita' per ogni bevanda; 
// l'atto di erogazione di una bevanda corrisponde alla diminuzione di un'unita'
// della disponibilita' della stessa e alla conservazione della moneta 
// (nelle monete conservate, non bisogna distinguere tra monete da 50 centesimi ed 1 euro).
// Se la bevanda non e' disponibile, non viene erogata e la moneta non viene conservata.
// La macchina puo' contenere al massimo 25 monete; 
// quando la macchina e' piena di monete, non accetta altre monete e, quindi, non eroga pie' alcuna bevanda.
