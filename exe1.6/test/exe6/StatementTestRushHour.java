...
public class StatementTestRushHour {

	@Test
	public void testMoveCar() {
		RushHour r1 = new RushHour();  // costruttore
		assertFalse(r1.moveCar(-1, 0, 0)); // inidici sbagliati
	...
	// in questo caso Statement test => Branch Test
}
